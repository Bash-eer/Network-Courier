...
export default {
  ...
  props: ["dialogData", "title", "updateDialogData"],
  components: {},
  data() {
    return {
      v$: useVuelidate(),
  ...
  methods: {
    ...mapActions({
      fetchPrintLabel: "CheckInTab/loadPrintLabel",
      fetchPrintPreview: "CheckInTab/loadPrintPreview",
      fetchInstructionSlipPreview: "CheckInTab/loadInstructionSlipPreview",
      fetchInstructionSlipLabel: "CheckInTab/loadInstructionSlipLabel",
      fetchAttemptSlipPrint: "operationsMovementChart/attemptSlipPrint",
      fetchAttemptSlipPreview: "CheckInTab/attemptSlipPreview",
      fetchChecklistSlipPrint: "CheckInTab/checklistSlipPrint",
      fetchChecklistSlipPreview: "CheckInTab/checklistSlipPreview",
    }),
    closeDialog() {
      this.$store.state.CheckInTab.isPrintPreviewDialog = false;
    },
    async printDocument() {
