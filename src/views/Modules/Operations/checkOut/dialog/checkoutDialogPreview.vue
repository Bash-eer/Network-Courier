...
export default {
  ...
  methods: {
    ...mapActions({
      isMovementChartPrintLabelDialog:
        "Checkout/showPrintPreviewDialog",
      fetchPrintLabel: "Checkout/loadPrintLabel",
      fetchPrintPreview: "Checkout/loadPrintPreview",
      fetchInstructionSlipPreview:
        "Checkout/loadInstructionSlipPreview",
      fetchInstructionSlipLabel:
        "Checkout/loadInstructionSlipLabel",
      fetchAttemptSlipPrint: "Checkout/attemptSlipPrint",
      fetchAttemptSlipPreview: "Checkout/attemptSlipPreview",
      fetchChecklistSlipPrint: "Checkout/checklistSlipPrint",
      fetchChecklistSlipPreview: "Checkout/checklistSlipPreview",
    }),
    closeDialog() {
      const dialogData = {
        displayDialog: false,
  ...
  computed: {
    ...mapGetters({
      documentData: "Checkout/getDocumentPreviewData",
    }),
  },
  created() {},
};
