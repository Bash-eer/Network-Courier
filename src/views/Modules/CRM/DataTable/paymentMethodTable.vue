<template>
  <DataTable
    ...
    filterDisplay="menu"
    :globalFilterFields="['payment_method', 'user.display_name', 'createdAt']"
  ...
  >
    ...
    >
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Payment Method'" class="mr-2">
...
export default {
  ...
  methods: {
    ...
    getPaymentMethodData(dialogData) {
      this.$emit("editPaymentMethod", dialogData);
    },
  },
  created() {
