<template>
  <div class="field col-12 md:col-12">
    <p class="edm-dialog-title text-left">Thank You Message</p>
    <TextAreaField
...
export default {
  ...
  created() {
    ...
    let thankYouMessageData = this.$store.state.contacts.thankYouMessageData;
    for (let t in thankYouMessageData) {
      if (
        thankYouMessageData[t]["event_id"] ==
        this.$store.state.contacts.inviteesEventId
      ) {
        this.details.message = thankYouMessageData[t]["message"];
      }
    }
  },
};
