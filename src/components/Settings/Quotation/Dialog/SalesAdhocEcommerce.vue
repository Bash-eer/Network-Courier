...
<div>
  ...
  <div class="row ml-2 table_div select-rate-content">
    ...
    <div class="flex flex-row justify-content-end rate-content">
      <h5 class="label-text rate-text">Rates</h5>
      <h5 class="label-text justify-content-end">Total Weight: 50 kg</h5>
      <h5 class="label-text justify-content-end">Vol. Weight: 10 kg</h5>
