<template>
  ...
  <div class="field col-12 md:col-12">
    <h5 class="dialog-label-text dialog-contact-header">Service Required</h5>
  </div>
  <div
    class="
      flex flex-row
  ...
  <div class="field col-12 md:col-12 ml-3">
    <h5 class="required dialog-label-text dialog-contact-header">Package Details</h5>
    <TextAreaField
...
export default {
  name: "AddBikeSelectMethodDialog",
  data: () => ({
    v$: useVuelidate(),
    details: {
      customer_type: "",
