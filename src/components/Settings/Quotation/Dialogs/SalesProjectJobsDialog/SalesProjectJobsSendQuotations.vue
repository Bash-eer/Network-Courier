<template>
      ...
      <div class="formParentDiv formDiv">
        <div class="formgrid grid mt-4">
          <div class="field col-12 md:col-6">
            <h5 class="dialog-label-text font-size-12 " placeholder="0.00">
  ...
  <div class="flex flex-column pb-4 pl-2 pr-2 pt-2 ml-2 mt-2">
    <div class="row">
      <div class="col-12 text color-343434">
        <span class="ml-3"> Contract settings </span>
      </div>
    </div>
  </div>
  <span class="ml-2 font-size-12 color-343434 ">Contact Person</span>
...
export default {
  name: "SalesProjectJobsSendQuotations",
  ...
  methods: {
    goBackHandler() {
      this.$store.dispatch("quotation/navigateStepper", {
        step: "SalesProjectJobsCostingDetails",
      });
    },
    submitData() {
      if (this.v$.$invalid) {
      ...
      if (!this.v$.$invalid) {
        ...
        this.$store.dispatch("quotation/navigateStepper", {
          step: "SalesProjectJobsSendQuotations",
        });
      }
    },
  },
