    ...
    <div class="formgrid grid">
      <div class="field col-12 md:col-4">
        ...
        <TextField
          label="credit_limit"
          type="number"
          v-model="details.Project.credit_limit"
          :classes="{
            'p-invalid': v$.details.Project.credit_limit.$invalid && submitted,
            'inputfield w-full dialog-field-text py-2': true,
          }"
        />
      </div>
      <div class="field col-12 md:col-4">
        ...
        <TextField
          label="credit_term"
          type="number"
          v-model="details.Project.credit_term"
          :classes="{
            'inputfield w-full dialog-field-text py-2': true,
          }"
        />
    ...
    <div class="formgrid grid">
      <div class="field col-12 md:col-4">
        ...
        <TextField
          label="special_urget_price"
          type="number"
          v-model="details.Project.special_urget_price"
          :classes="{
            'p-invalid':
              v$.details.Project.special_urget_price.$invalid && submitted,
            'inputfield w-full dialog-field-text py-2': true,
          }"
        />
      </div>
      <div class="field col-12 md:col-4">
        ...
        <TextField
          label="sur_charge"
          type="number"
          v-model="details.Project.sur_charge"
          :classes="{
            'p-invalid': v$.details.Project.sur_charge.$invalid && submitted,
            'inputfield w-full dialog-field-text py-2': true,
          }"
        />
      </div>
      <div class="field col-12 md:col-4">
        ...
        <TextField
          label="island_charge"
          type="number"
          v-model="details.Project.island_charge"
          :classes="{
            'inputfield w-full dialog-field-text py-2': true,
          }"
        />
      ...
      <div class="col-3">
        <div class="flex flex-row">
          <div class="flex">
            <CheckBox
              v-bind:checker="
                details.Project.weekend_2nd_trip_charge == true
                  ? [
                      {
                        name: 'weekend_2nd_trip_charge',
                        key: 'wd',
      ...
      <div class="col-3">
        <div class="flex flex-row">
          <div class="flex">
            <CheckBox
              v-bind:checker="
                details.Project.saturday_2nd_trip_charge == true
                  ? [
                      {
                        name: 'saturday_2nd_trip_charge',
                        key: 'wd',
      ...
      <div class="col-3">
        <div class="flex flex-row">
          <div class="flex">
            <CheckBox
              v-bind:checker="
                details.Project.return_trip_charge == true
                  ? [
                      {
                        name: 'return_trip_charge',
                        key: 'wd',
      ...
      <div class="col-3">
        <div class="flex flex-row">
          <div class="flex">
            <CheckBox
              v-bind:checker="
                details.Project.return_trip_partial_charge == true
                  ? [
                      {
                        name: 'return_trip_partial_charge',
                        key: 'wd',
      ...
      <div class="col-3">
        <div class="flex flex-row">
          <div class="flex">
            <CheckBox
              v-bind:checker="
                details.Project.collection_trip_charge == true
                  ? [
                      {
                        name: 'collection_trip_charge',
                        key: 'wd',
      ...
      <div class="col-3">
        <div class="flex flex-row">
          <div class="flex">
            <CheckBox
              v-bind:checker="
                details.Project.special_monitoring == true
                  ? [
                      {
                        name: 'special_monitoring',
                        key: 'wd',
      ...
      <div class="col-3">
        <div class="flex flex-row">
          <div class="flex">
            <CheckBox
              v-bind:checker="
                details.Project.call_centre == true
                  ? [
                      {
                        name: 'call_centre',
                        key: 'wd',
