...
export default {
  ...
  methods: {
    ...mapActions("express", ["createEcommerceVanRates"]),
    ...
    async save() {
      ...
      try {
        ...
        Object.assign(this.formData, {
          delivery_type_id: this.$store.state.express.vanDeliveryId,
        });
        Object.assign(this.formData, {
          rate_id: this.$store.state.express.rateCardId,
        });
        await this.createEcommerceVanRates(this.formData).then(() => {
          this.bool = false;
        });
