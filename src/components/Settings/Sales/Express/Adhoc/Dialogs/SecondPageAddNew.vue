      ...
      if (!this.v$.$invalid) {
        ...
        if (this.ZoneData) {
          let respectiveFromZoneData = this.ZoneData.find(
            (itm) => itm.name == this.details.fromZone.trim()
            // (itm) => itm.name == splitarr[0].trim()
          );

          let respectiveToZoneData = this.ZoneData.find(
            (itm) => itm.name == this.details.toZone.trim()
        ...
        this.details.rate_card_id = this.$route.params.id;
        this.details.zone_ranges = zone_ranges;
        this.details.rates[0]["zones"] = this.details.zone_ranges;
