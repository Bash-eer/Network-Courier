  ...
  <div class="w-100 tab-class">
    <div class="flex justify-content-between py-3 tabsBar">
      ...
      <div class="flex mr-1">
        ...
        <Buttons
          v-if="
            $store.state.internationalInbound.currentTabValue ==
            'AdditionalCharges'
          "
          label="Add New"
          class="ml-2"
        ...
        <Buttons
          v-if="
            $store.state.internationalInbound.currentTabValue == 'OtherCharges'
          "
          label="Add New"
          class="ml-2"
          button_class="p-button-sm add-btn custom-add-btn bg-357dea"
