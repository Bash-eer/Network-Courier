<template>
  ...
  <div class="flex justify-content-between mt-3 ml-2 mr-2 mb-3">
    <div class="flex">
      <p class="Header-Style">Questionnaire</p>
    </div>
    <div class="flex">
  ...
  <DataTable
    ...
    :tableData="$store.state['internationalInbound']['addQuestionnaireData']"
...
import {InboundQuestionnaireTableColumnData} from "../../const.js";
export default {
  data: () => ({
    tableColumn: InboundQuestionnaireTableColumnData,
  }),
  methods: {
