<template>
  ...
  <p class="txt ml-3 mt-5 add_rates">Add Rates</p>
  <div v-for="(rate, index) of addRates" :key="rate">
    ...
    <div class="formgrid grid mt-1">
      <div class="field col-12 md:col-6">
        <h5 class="dialog-label-text mt-2 ml-2">
      ...
      <div class="field col-12 md:col-6">
        <h5 class="dialog-label-text unit_rates">Units Rate($)</h5>
        <TextField
...
export default {
  ...
  methods: {
    ...
    submitData() {
      ...
      this.$store.state.masters.expressExpressRatesFormData["region_id"] =
        this.$store.state.masters.expressExpressRatesFormData["id"];
