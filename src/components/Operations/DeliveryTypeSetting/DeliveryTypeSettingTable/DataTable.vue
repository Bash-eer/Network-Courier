  ...
  >
    ...
    >
      <template #body="slotProps">
        <!-- TEMPLATE : ACTIONS -->
        <!-- CODE NEEDED -->
        <div v-if="this.tableName == 'BikeDeliveryTypeData'">
        ...
        <div v-if="this.tableName == 'VanDeliveryTypeData'">
          <span v-if="col.header == 'Actions'">
            <CustomSpeedDials
              storePath="operationAllotment"
              :dataName="tableDataName"
        ...
        <div v-if="this.tableName == 'RapidoDeliveryTypeData'">
          <span v-if="col.header == 'Actions'">
            <CustomSpeedDials
              storePath="operationAllotment"
              :dataName="tableDataName"
        ...
        <span v-if="col.header == 'Trip No'" class="ml-3">
          {{ slotProps.data[col.field] }}
        </span>
