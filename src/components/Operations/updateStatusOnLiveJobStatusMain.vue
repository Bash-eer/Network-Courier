<template>
  <Dialog
    v-model:visible="$store.state['liveJobStatus'].updateStatusDialog"
    :style="{
      width: getWidth(),
      height: getHeight(),
    }"
...
import UpdateStatusOnLiveJobStatus from "./LiveJobStatus/updateStatusOnLiveJobStatus.vue";
export default {
  name: "UpdateStatusMain",
  props: ["dialogComponent", "dialogData"],
  components: {
    Dialog,
    UpdateStatusOnLiveJobStatus,
  },
  data() {
    return {};
  },
