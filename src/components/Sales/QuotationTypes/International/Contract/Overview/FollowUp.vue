<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div
      class="international-contract-followup-header express-international-font"
    >
      Follow Up
    </div>
    <div
      class="blue pointer-cursor international-contract-followup-title mr-3"
      @click="
        openDialog('AddFollowUP', 'salesInternationalContract', 'Add Follow Up')
      "
    >
      +Add New
    </div>
...
.international-contract-followup-title {
  font-size: 14px;
  font-weight: 700;
  line-height: 17px;
...
.international-contract-followup-header {
  color: #343434;
  font-size: 16px;
}
</style>
