  ...
  >
      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Contact'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex international-adhoc-data-table-heading">
              {{ slotProps.data["contact_name"] }}
            </div>
            <div class="flex international-adhoc-data-table-sub">
        ...
        >
          <span
            ...
            :class="
              ...
              slotProps.data[col.field] == 'active'
                ? 'international-adhoc-data-table-activeClass'
                : 'international-adhoc-data-table-inactiveClass'
            "
            >{{
              slotProps.data[col.field] == "Active" ||
              slotProps.data[col.field] == "active"
          ...
          >
          <span
            class="international-adhoc-data-table-deletedClass"
            v-if="slotProps.data[col.field] == 'deleted'"
          >
    ...
    <template #expansion="slotProps">
      <span v-if="tableName == 'QuotationTabTable' && slotProps.data.revisions">
        ...
        <span v-if="slotProps.data.revisions.length == 0">
          <div class="international-adhoc-data-table-no-data p-3">
...
.international-adhoc-data-table-no-data {
  text-align: center;
  font-weight: bold;
}
::v-deep .deleted_row {
...
.international-adhoc-data-table-heading {
  color: #4e5868;
}
.international-adhoc-data-table-sub {
  color: #7e84a7;
}
...
.international-adhoc-data-table-deletedClass {
  color: #c01717;
  font-weight: bold;
}
.international-adhoc-data-table-inactiveClass {
