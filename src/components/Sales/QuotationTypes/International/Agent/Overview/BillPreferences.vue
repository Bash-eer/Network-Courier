<template>
  <div class="flex justify-content-between">
    <div
      class="
        flex
        international-agent-billpreferences-header
    ...
    <div class="flex">
      <span
        ...
        class="international-agent-billpreferences-add"
        @click="
          openDialog(
            'BillingPreference',
  ...
  <div v-if="BillPreferencesData.length != 0" class="mt-3 mb-6">
    <p class="international-agent-billpreferences-subFormHeaders mb-2">
      Billing Address
    </p>
    <span class="international-agent-billpreferences-billDetails">{{
      BillPreferencesData[0].billing_address
    }}</span>
    <p class="international-agent-billpreferences-subFormHeaders mb-2 mt-3">
    ...
    <div class="flex flex-row">
      ...
      >
        <span v-if="invoiceNotificatons == true">
          ...
          <label
            class="international-agent-billpreferences-billDetails mt-1 ml-1"
            for="2"
...
<style scoped>
.international-agent-billpreferences-billDetails {
  color: #343434;
  font-size: 12px;
  font-weight: 700;
}
.international-agent-billpreferences-subFormHeaders {
  color: #4e5868;
  font-size: 12px;
  font-weight: 700;
}
.international-agent-billpreferences-horizontal-line {
  margin: 0px !important;
  margin-top: 1% !important;
}
.international-agent-billpreferences-add {
  color: blue;
  font-size: 14px;
  cursor: pointer;
}
