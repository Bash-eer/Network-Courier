<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div class="international-attachments-header express-international-font">
      Attachments
    </div>
    <div
      class="blue pointer-cursor title mr-3"
      @click="
        openDialog('AddAttachments', 'salesInternationalAgent', 'Attachments')
      "
    >
      + Upload
    </div>
...
.international-attachments-header {
  color: #343434;
  font-size: 16px;
}
</style>
