  ...
  >
      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Contact'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex international-agent-datatable-heading">
              {{ slotProps.data["contact_name"] }}
            </div>
            <div class="flex international-agent-datatable-sub">{{ slotProps.data["contact_no"] }}</div>
          </div>
        </span>

         <span v-if="col.header == 'Address'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex international-agent-datatable-heading">{{ slotProps.data["address"] }}</div>
            <div class="flex international-agent-datatable-sub">{{ slotProps.data["postal_code"] }}</div>
          </div>
        </span>
        ...
        >
          <span
            ...
            :class="
              ...
              slotProps.data[col.field] == 'active'
                ? 'international-agent-datatable-activeClass'
                : 'international-agent-datatable-inactiveClass'
            "
            >{{
              slotProps.data[col.field] == "Active" ||
              slotProps.data[col.field] == "active"
          ...
          >
          <span
            class="international-agent-datatable-deletedClass"
            v-if="slotProps.data[col.field] == 'deleted'"
          >
        ...
        <span v-if="col.header == 'Contacts'" class="mr-2 pt-2">
          <div class="flex flex-column mt-4">
            ...
            <div class="flex international-agent-datatable-sub">
    ...
    <template #expansion="slotProps">
      ...
      <span v-if="tableName == 'QuotationTabTable' && slotProps.data.revisions">
        ...
        <span v-if="slotProps.data.revisions.length == 0">
          <div class="international-agent-datatable-no_data align-items-center p-3">No Revisions to show</div></span
        >
      </span>
    </template>
  </DataTable>
...
.international-agent-datatable-no_data {
  font-weight: bold;
}
::v-deep .deleted_row {
...
.international-agent-datatable-deletedClass {
  color: #c01717;
  font-weight: bold;
}
.international-agent-datatable-inactiveClass {
...
.international-agent-datatable-heading {
  color: #4e5868;
}
.international-agent-datatable-sub {
  color: #7e84a7;
}
.quotation {
