      ...
      >
        ...
        <keep-alive v-if="type == 'salesHome'">
          <component
            ...
            :tableData="$store.state['salesExpressContractVanProjectJobs'][tabs.data]"
            :tableColumns="$store.state['salesExpressContractVanProjectJobs'][tabs.columns]"
            :is="tabs.tab"
          ></component>
        </keep-alive>
  ...
  methods: {
    ...
    tabChange(tab) {
      ...
      if (
        ...
        this.$store.state.salesExpressContractVanProjectJobs.expressContractVanProjectJobsTimeLineCurrentTab =
          tab;
        ...
        if (tab == "Overview") {
          ...
          this.$store.dispatch(
            "salesExpressContractVanProjectJobs/updateExpressContractVanProjectJobsTimeLineData",
            {
