  ...
  >
      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Contact'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex van-datatable-heading">
              {{ slotProps.data["contact_name"] }}
            </div>
            <div class="flex van-datatable-sub">
    ...
    <template #expansion="slotProps">
      <span v-if="tableName == 'QuotationTabTable' && slotProps.data.revisions">
        ...
        <span v-if="slotProps.data.revisions.length == 0">
          <div class="van-datatable-no-data p-3">
            No Revisions to show
          </div></span
        >
      </span>

      <span v-if="tableName == 'timeLineExpressContractBikeProjectJobsCostCenterTable'">
        <div class="mr-2 ml-2 mt-2">
          <div class="van-datatable-seaDivLarge p-3">
            <div class="flex flex-wrap justify-content-between">
              <div class="flex"><span class="header">Trip Schedule</span></div>
              <div class="flex"><i class="pi pi-ellipsis-v mt-2"></i></div>
            </div>
            <hr class="van-datatable-horizontal-line mb-2" />
            <TimeLineTable
          ...
          <div
            class="
              ...
              van-datatable-siteOfficeCharges
              mt-4
              mr-3
            "
          >
          ...
          <div class="flex flex-row ml-5 mb-3">
            ...
            >
              <div class="flex flex-row">
                ...
                <div class="flex mr-4">
                  <span class="mt-1 van-datatable-inclusions express-international-font">{{ index }}</span>
                </div>
              </div>
            </div>
          </div>
...
.van-datatable-heading {
  color: #4e5868;
}
.van-datatable-sub {
  color: #7e84a7;
}
.van-datatable-inclusions {
  font-size: 12px;
  color: #4e5868;
}
.van-datatable-siteOfficeCharges {
...
.van-datatable-horizontal-line {
  margin: 0px !important;
  margin-top: 1.1% !important;
}
.van-datatable-seaDivLarge {
  background: #f3f7ff;
