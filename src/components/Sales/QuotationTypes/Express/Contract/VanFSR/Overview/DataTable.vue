  ...
  >
      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Contact'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex van-fsr-data-table-heading">
              {{ slotProps.data["contact_name"] }}
            </div>
            <div class="flex van-fsr-data-table-sub">{{ slotProps.data["contact_no"] }}</div>
          </div>
        </span>
        ...
        <span v-if="col.header == 'Address'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex van-fsr-data-table-heading">{{ slotProps.data["address"] }}</div>
            <div class="flex van-fsr-data-table-sub">{{ slotProps.data["postal_code"] }}</div>
          </div>
        </span>
        ...
        >
          <span
            ...
            :class="
              ...
              slotProps.data[col.field] == 'active'
                ? 'van-fsr-data-table-active-class'
                : 'van-fsr-data-table-inactive-class'
            "
            >{{
              slotProps.data[col.field] == "Active" ||
              slotProps.data[col.field] == "active"
        ...
        <span v-if="col.header == 'Contacts'" class="mr-2 pt-2">
          <div class="flex flex-column mt-4">
            ...
            <div class="flex van-fsr-data-table-sub">
    ...
    <template #expansion="slotProps">
      ...
      <span v-if="tableName == 'QuotationTabTable' && slotProps.data.revisions">
        ...
        <span v-if="slotProps.data.revisions.length == 0">
          <div class="van-fsr-data-table-no-data p-3">No Revisions to show</div></span
        >
      </span>

      
      <span v-if="tableName == 'timeLineExpressContractVanFSRCostCenterTable'">
        <div class="mr-2 ml-2 mt-2">
          <div class="van-fsr-data-table-seadivlarge p-3">
            <div class="flex flex-wrap justify-content-between">
              <div class="flex"><span class="header">Trip Schedule</span></div>
              <div class="flex"><i class="pi pi-ellipsis-v mt-2"></i></div>
            </div>
            <hr class="van-fsr-data-table-horizontal-line mb-2" />
            <TimeLineTable
          ...
          <div
            class="
              ...
              van-fsr-data-table-site-office-charges
              mt-4
              mr-3
            "
          >
          ...
          <div class="flex flex-row ml-5 mb-3">
            ...
            >
              <div class="flex flex-row">
                ...
                <div class="flex mr-4">
                  <span class="mt-1 van-fsr-data-table-inclusions express-international-font">{{ index }}</span>
                </div>
              </div>
            </div>
          </div>
...
.van-fsr-data-table-heading {
  color: #4e5868;
}
.van-fsr-data-table-sub {
  color: #7e84a7;
}
.van-fsr-data-table-inclusions {
...
.van-fsr-data-table-horizontal-line {
  margin: 0px !important;
  margin-top: 1.1% !important;
}
.van-fsr-data-table-seadivlarge {
  background: #f3f7ff;
