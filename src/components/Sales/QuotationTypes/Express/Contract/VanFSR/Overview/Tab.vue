      ...
      >
        ...
        <keep-alive v-if="type == 'salesHome'">
          <component
            ...
            :tableData="$store.state['salesExpressContractVanFSR '][tabs.data]"
            :tableColumns="
              $store.state['salesExpressContractVanFSR'][tabs.columns]
            "
            :is="tabs.tab"
          ></component>
        </keep-alive>
  ...
  methods: {
    ...
    async tabChange(tab) {
      ...
      if (
        ...
        this.$store.state.salesExpressContractVanFSR.expressContractVanFSRCurrentTab =
          tab;
       ...
       await this.$store.dispatch(
        ...
        if (tab == "Overview") {
          ...
          await this.$store.dispatch(
            "salesExpressContractVanFSR/updateExpressContractVanFSRTimeLineData",
            {
