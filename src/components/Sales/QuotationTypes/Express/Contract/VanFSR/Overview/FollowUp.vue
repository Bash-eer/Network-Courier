<template>
  <div class="flex flex-row justify-content-between align-items-center">
    ...
    <div
      class="blue pointer-cursor van-fsr-follow-up-title mr-3"
      @click="
        openDialog('FollowUp', 'salesExpressContractVanFSR', 'Add FollowUp')
      "
    >
      +Add New
    </div>
