<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div class="bike-fsr-follow-up-header">Follow Up</div>
    <div
      class="blue pointer-cursor bike-fsr-follow-up-title mr-3"
      @click="
        openDialog('FollowUp', 'salesExpressContractBikeFSR', 'Add Follow Up')
      "
    >
      +Add New
    </div>
