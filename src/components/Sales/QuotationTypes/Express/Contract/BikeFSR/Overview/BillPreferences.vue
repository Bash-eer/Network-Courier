<template>
  <div class="flex justify-content-between">
    <div class="flex bike-fsr-header">Bill Preferences</div>
    <div class="flex">
      <span
  ...
  <hr class="bike-fsr-horizontal-line" />
  <div v-if="BillPreferencesData.length != 0" class="mt-3 mb-6">
    <p class="bike-fsr-sub-form-headers mb-2">Billing Address</p>
    <span class="bike-fsr-billDetails">{{
      BillPreferencesData[0].billing_address
    }}</span>
    <p class="bike-fsr-sub-form-headers mb-2 mt-3">Invoice Notification</p>
    <div class="flex flex-row">
      ...
      >
        <span v-if="invoiceNotificatons == true">
          ...
          <label class="bike-fsr-billDetails mt-1 ml-1" for="2">{{
            getLabel(index)
          }}</label>
        </span>
      </div>
    </div>
    <p class="bike-fsr-sub-form-headers mb-2 mt-3">Invoice Attachments</p>
    <div class="flex flex-row">
      <div
        class="flex mr-3"
    ...
    <p class="bike-fsr-sub-form-headers mb-2 mt-3">Attachment Format</p>
    <div class="flex flex-row">
      <div
        class="flex mr-3"
...
<style scoped>
.bike-fsr-billDetails {
  color: #343434;
  font-size: 12px;
  font-weight: 700;
}
.bike-fsr-sub-form-headers {
  color: #4e5868;
  font-size: 12px;
  font-weight: 700;
}
.bike-fsr-horizontal-line {
