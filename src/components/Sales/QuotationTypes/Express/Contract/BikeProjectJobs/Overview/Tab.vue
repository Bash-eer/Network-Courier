      ...
      >
        ...
        <keep-alive v-if="type == 'salesHome'">
          <component
            ...
            :tableData="
              $store.state['salesExpressContractBikeProjectJobs'][tabs.data]
            "
            :tableColumns="
              $store.state['salesExpressContractBikeProjectJobs'][tabs.columns]
            "
            :is="tabs.tab"
          ></component>
        </keep-alive>
  ...
  methods: {
    ...
    async tabChange(tab) {
      ...
      if (
        ...
        this.$store.state.salesExpressContractBikeProjectJobs.expressContractBikeProjectJobsTimeLineCurrentTab =
          tab;
        ...
        if (tab == "Overview") {
          ...
          this.$store.dispatch(
            "salesExpressContractBikeProjectJobs/updateExpressContractBikeProjectJobsTimeLineData",
            {
    ...
    openDialog(name, type, header) {
      if (type == "salesHome") {
        ...
        this.$store.getters[
          "salesExpressContractBikeProjectJobs/controlActivityDialog"
        ];
      }
    },
  },
