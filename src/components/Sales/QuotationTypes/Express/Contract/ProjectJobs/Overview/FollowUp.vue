<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div
      class="express-project-jobs-follow-up-header express-international-font"
    >
      Follow Up
    </div>
    <div
      class="blue pointer-cursor express-project-jobs-follow-up-title mr-3"
       @click="
        openDialog('AddFollowUp', 'salesExpressContractProjectJobs', 'Add FollowUp')
      "
    >
...
.express-project-jobs-follow-up-title {
...
.express-project-jobs-follow-up-header {
  color: #343434;
  font-size: 16px;
}
</style>
