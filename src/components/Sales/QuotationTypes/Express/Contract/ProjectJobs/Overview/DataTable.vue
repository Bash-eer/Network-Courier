  ...
  >
      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Contact'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex express-project-jobs-data-table-heading">
              {{ slotProps.data["contact_name"] }}
            </div>
            <div class="flex express-project-jobs-data-table-sub">
        ...
        >
          <span
            ...
            :class="
              ...
              slotProps.data[col.field] == 'active'
                ? 'express-project-jobs-data-table-active-class'
                : 'express-project-jobs-data-table-inactive-class'
            "
            >{{
              slotProps.data[col.field] == "Active" ||
              slotProps.data[col.field] == "active"
    ...
    <template #expansion="slotProps">
      <span v-if="tableName == 'QuotationTabTable' && slotProps.data.revisions">
        ...
        <span v-if="slotProps.data.revisions.length == 0">
          <div class="express-project-jobs-data-table-no_data p-3">
      ...
      <span v-if="tableName == 'timeLineExpressContractBikeCostCenterTable'">
        <div class="mr-2 ml-2 mt-2">
          <div class="express-project-jobs-data-table-seaDivLarge p-3">
            <div class="flex flex-wrap justify-content-between">
              <div class="flex"><span class="header">Trip Schedule</span></div>
              <div class="flex"><i class="pi pi-ellipsis-v mt-2"></i></div>
            </div>
            <hr class="express-project-jobs-data-table-horizontal-line mb-2" />
            <TimeLineTable
          ...
          <div
            class="
              ...
              express-project-jobs-data-table-siteOfficeCharges
              mt-4
              mr-3
            "
          >
              ...
              <div class="flex flex-row">
                ...
                <div class="flex mr-4">
                  <span
                    class="
                      mt-1
                      express-project-jobs-data-table-inclusions
  ...
  methods: {
    ...
    onRowSelect(event) {
      ...
      if (this.tableName == "QuotationTabTable") {
        ...
        this.$store.state.salesExpressContractProjectJobs.expressRegionsTripTableData =
          null;

        this.$store.state.salesExpressContractProjectJobs.expressQuotationOverviewData =
          [];
        ...
        this.$store.state.salesExpressContractProjectJobs.expressQuotationOverviewData.push(
          overviewDetailsObj
        );
        ...
        this.$store.state.salesExpressContractProjectJobs.salesQuotationId =
          event.data.quotation_id;
        this.$router.push({
          name: "expressTracker",
        });
        this.$store.dispatch(
          "salesExpressContractProjectJobs/loadBillPreferences"
        );
        this.$store.dispatch("salesExpressContractProjectJobs/loadCostCentres");
        this.$store.dispatch("salesExpressContractProjectJobs/loadAttachments");
        this.$store.dispatch("salesExpressContractProjectJobs/loadFollowUp");
      }
      if (this.tableName == "SalesTab") {
        ...
        this.$store.dispatch(
          "salesExpressContractProjectJobs/loadContactsApi",
          {
            apiPath: apiPath,
          }
        );
        this.$store.dispatch(
          "salesExpressContractProjectJobs/loadQuotationApi",
          {
            id: event.data.id,
          }
        );
...
.express-project-jobs-data-table-no_data {
  text-align: center;
  font-weight: bold;
}
::v-deep .deleted_row {
...
.express-project-jobs-data-table-heading {
  color: #4e5868;
}
.express-project-jobs-data-table-sub {
  color: #7e84a7;
}
.express-project-jobs-data-table-inclusions {
  font-size: 12px;
...
.express-project-jobs-data-table-horizontal-line {
  margin: 0px !important;
  margin-top: 1.1% !important;
}
.express-project-jobs-data-table-seaDivLarge {
  background: #f3f7ff;
...
.express-project-jobs-data-table-quotation {
