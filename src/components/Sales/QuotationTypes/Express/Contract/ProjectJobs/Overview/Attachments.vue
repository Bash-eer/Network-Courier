<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div
      class="
        express-project-jobs-bill-attachments-header express-international-font
      "
    >
      Attachments
    </div>
    <div class="blue pointer-cursor title mr-3" 
    id="foo"
      @click="
        openDialog(
          'Upload',
...
.express-project-jobs-bill-attachments-header {
  color: #343434;
  font-size: 16px;
}
</style>
