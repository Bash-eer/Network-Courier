      ...
      >
        ...
        <keep-alive v-if="type == 'salesHome'">
          <component
            ...
            :tableData="
              $store.state['salesExpressContractProjectJobs'][tabs.data]
            "
            :tableColumns="
              $store.state['salesExpressContractProjectJobs'][tabs.columns]
            "
            :is="tabs.tab"
          ></component>
        </keep-alive>
  ...
  methods: {
    ...
    tabChange(tab) {
      ...
      if (
        ...
        this.$store.state.salesExpressContractProjectJobs.expressContractProjectJobsCurrentTab =
          tab;

        this.$store.dispatch(
          "salesExpressContractProjectJobs/resetExpressContractProjectsJobsTimeLineData",
          {
            data: [
              {
                index: 0,
        ...
        if (tab == "Overview") {
          ...
          this.$store.dispatch(
            "salesExpressContractProjectJobs/updateExpressContractProjectsJobsTimeLineData",
            {
    ...
    openDialog(name, type, header) {
      if (type == "salesHome") {
        ...
        this.$store.getters[
          "salesExpressContractProjectJobs/controlActivityDialog"
        ];
      }
    },
  },
