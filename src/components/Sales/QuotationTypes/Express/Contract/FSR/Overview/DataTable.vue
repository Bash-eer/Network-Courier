      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Contact'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex express-fsr-data-table-heading">
              {{ slotProps.data["contact_name"] }}
            </div>
            <div class="flex express-fsr-data-table-sub">
        ...
        >
          <span
            ...
            :class="
              ...
              slotProps.data[col.field] == 'active'
                ? 'express-fsr-data-table-active-class'
                : 'express-fsr-data-table-inactive-class'
            "
            >{{
              slotProps.data[col.field] == "Active" ||
              slotProps.data[col.field] == "active"
...
.express-fsr-data-table-heading {
  color: #4e5868;
}
.express-fsr-data-table-sub {
  color: #7e84a7;
}
.express-fsr-data-table-inclusions {
  font-size: 12px;
  color: #4e5868;
}
.address {
