<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div class="bike-fsr-follow-up-header express-international-font">
      Follow Up
    </div>
    <div
      class="blue pointer-cursor fsr-follow-up-title mr-3"
      @click="
        openDialog('FollowUp', 'salesExpressContractFSR', 'Add FollowUp')
      "
    >
      +Add New
    </div>
