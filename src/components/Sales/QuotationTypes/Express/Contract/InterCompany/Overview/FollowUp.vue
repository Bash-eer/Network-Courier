<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div
      class="express-inter-company-follow-up-header express-international-font"
    >
      Follow Up
    </div>
    <div
      class="blue pointer-cursor express-inter-company-follow-up-title mr-3"
      @click="
        openDialog('FollowUp', 'salesExpressContractInterCompany', 'FollowUp')
      "
    >
      +Add New
    </div>
...
.express-inter-company-follow-up-title {
...
.express-inter-company-follow-up-header {
  color: #343434;
  font-size: 16px;
}
</style>
