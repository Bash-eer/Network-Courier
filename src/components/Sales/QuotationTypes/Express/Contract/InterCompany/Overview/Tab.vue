  ...
  methods: {
    ...
    tabChange(tab) {
      ...
      if (
        ...
        this.$store.state.salesExpressContractInterCompany.expressContractInterCompanyCurrentTab =
          tab;
        ...
        if (tab == "Overview") {
          ...
          this.$store.dispatch(
            "salesExpressContractInterCompany/updateExpressContractInterCompanyTimeLineData",
            {
