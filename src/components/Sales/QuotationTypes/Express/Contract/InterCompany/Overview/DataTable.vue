  ...
  >
      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Contact'" class="mr-2">
          <div class="flex flex-column">
            <div class="flex express-inter-company-data-table-heading">
              {{ slotProps.data["contact_name"] }}
            </div>
            <div class="flex express-inter-company-data-table-sub">
        ...
        >
          <span
            ...
            :class="
              ...
              slotProps.data[col.field] == 'active'
                ? 'express-inter-company-data-table-active-class'
                : 'express-inter-company-data-table-inactive-class'
            "
            >{{
              slotProps.data[col.field] == "Active" ||
              slotProps.data[col.field] == "active"
    ...
    <template #expansion="slotProps">
      ...
      <span v-if="tableName == 'QuotationTabTable' && slotProps.data.revisions">
        ...
        <span v-if="slotProps.data.revisions.length == 0">
          <div class="express-inter-company-data-table-no_data p-3">
      ...
      <span v-if="tableName == 'timeLineExpressContractBikeCostCenterTable'">
        <div class="mr-2 ml-2 mt-2">
          <div class="express-inter-company-data-table-seaDivLarge p-3">
            <div class="flex flex-wrap justify-content-between">
              <div class="flex"><span class="header">Trip Schedule</span></div>
              <div class="flex"><i class="pi pi-ellipsis-v mt-2"></i></div>
            </div>
            <hr class="express-inter-company-data-table-horizontal-line mb-2" />
            <TimeLineTable
          ...
          <div
            class="
              ...
              express-inter-company-data-table-siteOfficeCharges
              mt-4
              mr-3
            "
          >
              ...
              <div class="flex flex-row">
                ...
                <div class="flex mr-4">
                  <span
                    class="
                      mt-1
                      express-inter-company-data-table-inclusions
...
.express-inter-company-data-table-no_data {
  text-align: center;
  font-weight: bold;
}
::v-deep .deleted_row {
...
.express-inter-company-data-table-heading {
  color: #4e5868;
}
.express-inter-company-data-table-sub {
  color: #7e84a7;
}
.express-inter-company-data-table-inclusions {
  font-size: 12px;
...
.express-inter-company-data-table-horizontal-line {
  margin: 0px !important;
  margin-top: 1.1% !important;
}
.express-inter-company-data-table-seaDivLarge {
  background: #f3f7ff;
...
.express-inter-company-data-table-quotation {
