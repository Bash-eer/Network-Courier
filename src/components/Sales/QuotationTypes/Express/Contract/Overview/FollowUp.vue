<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div class="van-follow-up-header express-international-font">Follow Up</div>
    <div
      class="blue pointer-cursor van-follow-up-title mr-3"
      @click="
        openDialog('AddFollowUp', 'salesExpressContractVan', 'Add Follow Up')
      "
    >
      +Add New
    </div>
