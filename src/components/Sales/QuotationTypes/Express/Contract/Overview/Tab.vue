  ...
  methods: {
    ...
    tabChange(tab) {
      ...
      if (
        ...
        this.$store.state.salesExpressContract.expressContractVanTimeLineCurrentTab =
          tab;

        this.$store.dispatch(
          "salesExpressContract/resetExpressVanTimeLineData",
          {
            data: [
              {
                index: 0,
        ...
        if (tab == "Overview") {
          ...
          this.$store.dispatch(
            "salesExpressContract/updateExpressContractVanTimeLineData",
            {
