      ...
      >
        ...
        <keep-alive v-if="type == 'salesHome'">
          <component
            ...
            :tableData="$store.state['salesExpressAdhoc'][tabs.data]"
            :tableColumns="$store.state['salesExpressAdhoc'][tabs.columns]"
            :is="tabs.tab"
          ></component>
        </keep-alive>
  ...
  methods: {
    ...
    async tabChange(tab) {
      ...
      if (tab == "Overview" || tab == "FollowUp" || tab == "Attachments") {
        this.$store.state.salesExpressAdhoc.expressAdhocTimeLineCurrentTab =
          tab;
        ...
        if (tab == "Overview") {
          ...
          this.$store.dispatch(
            "salesExpressAdhoc/updateExpressAdhocTimeLineData",
            {
        ...
        if (tab == "FollowUp") {
          ...
          followUpObject["markerComponent"] = "ExpressAdhocFollowUp";
        ...
        if (tab == "Attachments") {
          ...
          attachmentsObject["markerComponent"] = "ExpressAdhocAttachments";
