  ...
  >
        ...
        >
          <span
            ...
            :class="
              ...
              slotProps.data[col.field] == 'active'
                ? 'bold-700 color-17c079'
                : 'color-ea6e39 bold-700'
            "
            >{{
              slotProps.data[col.field] == "Active" ||
              slotProps.data[col.field] == "active"
    ...
    <template #expansion="slotProps">
      <span v-if="tableName == 'QuotationTabTable' && slotProps.data.revisions">
        ...
        <span v-if="slotProps.data.revisions.length == 0">
          <div class="bold-700 text-center p-3">No Revisions to show</div></span
        >
      </span>

      <span v-if="tableName == 'timeLineExpressContractBikeCostCenterTable'">
        <div class="mr-2 ml-2 mt-2">
          <div class="bg-f3f7ff border-radius-8 p-3">
...
bg-f3f7ff border-radius-8 .express-inter-company-data-table-seaDivLarge {
