<template>
  <div>
    <span class="add-follow-heading">Call Type</span>
    <div class="flex flex-row mt-2 add-follow-content">
      <div
        class="flex mr-3"
...
export default {
  ...
  methods: {
    handleClick() {
      console.log(this.details.caller, "/////////");
      axios.post("/sales/quotation/followup", {
        quotation_id: this.$route.params.id,
        call_type: this.details.call_type,
        // internal_call_received_by: this.details.caller,
        internal_call_received_by: "Murali",
        date_and_time: this.details.date_time,
        customer_contact_no: this.details.contactNo,
        // customer_name: this.details.customer,
        customer_name: "trump",
        subject: this.details.designation,
        whatsapp_no: this.details.whatsapp_number,
        email: this.details["email"],
        discussion_detaits: this.details.reamrks,
        attachments: {
