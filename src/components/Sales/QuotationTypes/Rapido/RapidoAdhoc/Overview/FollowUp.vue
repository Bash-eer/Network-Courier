<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div class="rapido-adhoc-follow-up-header  express-international-font">Follow Up</div>
    <div
      class="blue pointer-cursor rapido-adhoc-follow-up-title mr-3"
      @click="
        openDialog('AddFollowUp', 'salesRapidoAdhoc', 'Add Follow Up')
      "
    >
      +Add New
