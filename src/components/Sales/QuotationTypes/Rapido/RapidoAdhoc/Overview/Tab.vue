      ...
      >
        <keep-alive v-if="type == 'salesHome'">
          <component
            ...
            :tableData="$store.state['salesRapidoAdhoc'][tabs.data]"
            :tableColumns="$store.state['salesRapidoAdhoc'][tabs.columns]"
            :is="tabs.tab"
          ></component>
        </keep-alive>
  ...
  methods: {
    ...
    async tabChange(tab) {
      ...
      if (tab == "Overview" || tab == "FollowUp" || tab == "Attachments") {
        this.$store.state.salesRapidoAdhoc.rapidoAdhocTimeLineCurrentTab = tab;
        ...
        if (tab == "Overview") {
          ...
          this.$store.dispatch(
            "salesRapidoAdhoc/updateRapidoAdhocTimeLineData",
            {
    ...
    async loadFunction(tab) {
      if (tab == "Overview") {
        await this.$store.dispatch(
          "salesRapidoAdhoc/loadRapidoAdhocOverviewData",
          {
