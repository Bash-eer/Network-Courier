<template>
  <div class="flex flex-row justify-content-between align-items-center">
    <div class="rapido-contract-followup-header express-international-font">Follow Up</div>
    <div
      class="blue pointer-cursor rapido-contract-followup-title mr-3"
      @click="
        openDialog('AddFollowUp', 'salesRapidoContract', 'Add FollowUp')
      "
    >
      +Add New
    </div>
...
.rapido-contract-followup-title {
  font-size: 14px;
  font-weight: 700;
  line-height: 17px;
...
.rapido-contract-followup-header {
  color: #343434;
  font-size: 16px;
}
</style>
