      ...
      <template #body="slotProps">
        ...
        <span v-if="col.header == 'Actions'" class="flex align-items-center">
          ...
          <CustomSpeedDials
            ...
            :customDialData="getOverlayData(slotProps.data)"
          />
        </span>
...
import {
  SalesApprovalsContractOverlayData,
  SalesApprovalsRateAdjesmentOverlayData,
} from "../Const";
    ...
    getOverlayData(e) {
      switch (this.tableName) {
        case "ApprovalsContractTab":
          ...
          //   data=
          // }
          return SalesApprovalsContractOverlayData.filter((i)=>!(e.status=='Approved'&&i.label=='Retrieve'));

        case "ApprovalsTerminationTab":
          return SalesApprovalsTerminationOverlayData;
        case "ApprovalsRateAdjustment":
          return SalesApprovalsRateAdjesmentOverlayData;
        default:
