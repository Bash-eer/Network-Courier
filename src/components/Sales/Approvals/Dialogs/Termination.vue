  ...
  <div class="sales-termination-template">
    ...
    >
      ...
      <div class="flex align-items-center">
        ...
        <div
          ...
          @click="
            goToContractOverview(
              incomingData.customer_type,
              incomingData.business_type,
              incomingData.id,
              contract_profile_id
            )
          "
        ...
        <div
          v-if="incomingData?.status == 'Terminated'"
...
export default {
  ...
  methods: {
    getHeader(index) {
      ...
      switch (index) {
        ...
        case "non_yearly_contract":
          header = "Non-Yearly Contract (Terms)";
          break;
    ...
    goToContractOverview(
          ...
          switch (expressContractService) {
            case "Bike":
              this.$router.push({
                ...
                params: { id: contractId, type: contract, mode: "history" },
              });
              break;
            case "Van":
              this.$router.push({
      ...
      this.$store.dispatch("salesApproval/closeDialog");
    },
  },
  mounted() {
    if (this.$store.state.salesApproval.approvalsTerminationStateData) {
