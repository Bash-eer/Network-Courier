  ...
  >
    ...
    >
      <template
        ...
        "
      >
        <span v-if="col.header == 'Increment amount (S$)'" key="renderKey">
          <NumberField v-model="data[field]" :showButtons="true" autofocus />
        </span>
      ...
      <template
        #body="slotProps"
        v-if="col.header == 'Quotation' || col.header == 'Select'"
      >
        <!-- <span v-if="col.header == 'Select'">
          <SingleCheckBox
            :label="slotProps.data['selected']"
...
export default {
  ...
  methods: {
    ...
    onCellEditComplete(event) {
      ...
      // console.log(this.bulkAdjustmentAddNewData, "ecom cell edit");
    },
