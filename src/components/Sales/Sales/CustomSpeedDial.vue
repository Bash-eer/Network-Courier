        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Toggle
                  v-on:childToParent="disableRow(items.label)"
    ...
    menuClicked(choice) {
      if (choice == "Delete") {
        this.$confirm.require({
          ...
          accept: () => {
            this.$store.dispatch("salesSales/DELETECRUDOPERATION", {
              // path: "salesCompany/delete/" + this.rowData.id,
              path: "sales/profiles/" + this.rowData.id,
              method: "DELETE",
        ...
        this.$store.state.salesSales.companyCreationStateData = this.rowData;
