      ...
      <div class="sales-selectRate-tableDesign mt-3">
        <span class="flex grid align-items-center mb-0 pb-0">
          ...
          >
            ...
            <p class="bold-600 font-size-14 ml-3 color-66c11e">
              Chargable Weight:
              {{
                Number(
                  Math.max(
        ...
        <FormTables
          ...
          formTableDataName="CreateQuotationRapidoAdhoc"
...
export default {
  ...
  created() {
    ...
    if (this.$store.state.salesRapidoAdhoc?.RapidoRowData?.id) {
      this.$store.state.salesRapidoAdhoc.inspectionsDropDownTableDataOne =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.rapido_adhoc_specifics.delivery_charges;
      this.details.kg =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.rapido_adhoc_specifics.weight;
      this.details.width =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.rapido_adhoc_specifics.width;
      this.details.height =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.rapido_adhoc_specifics.height;
      this.details.length =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.rapido_adhoc_specifics.length;
      this.details.from_postal_code =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.rapido_adhoc_specifics.from_postal_code;
      this.details.to_postal_code =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.rapido_adhoc_specifics.to_postal_code;
      this.details.remarks =
        this.$store.state.salesRapidoAdhoc.RapidoRowData.remarks;
    }
  },
  watch: {
