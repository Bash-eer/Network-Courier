<template>
  <div>
    <div class="flex align-items-end">
      <div class="field col">
        <h5 class="required dialog-label-text">Origin Country Import</h5>
      ...
      <div class="field col">
        ...
        <DropDown
          :data="Origin_country"
          placeholder="Please Select"
          v-model="origin_country_postal_code"
        />
      </div>
    </div>
    <div class="flex align-items-end">
      ...
      <div class="field col">
        ...
        <DropDown
          :data="Origin_country"
          placeholder="Please Select"
          v-model="destination_country_postal_code"
        />
      </div>
    </div>
  ...
  <InternationalAdhocDialogTwoAdd />
  ...
  <div class="add_weight" @click="addNewRow">+ Add More Weight</div>
...
import InternationalAdhocDialogTwoAdd from "../../International/Adhoc/InternationalAdhocDialogTwoAdd.vue";
