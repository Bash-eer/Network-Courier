<template>
  <div class="card">
    <!-- <div id="JobPriorityId" class="flex justify-content-around  mb-2">
      <div
        class="
...
export default {
  ...
  watch: {
    selectedUpdateData: {
      handler() {
        this.selectedUpdateDataOne = this.selectedUpdateData;
        this.updateData();
      },
      deep: true,
    },
